...
def letter_stat(our_str):
    """
    Функция принимает на вход строку и формирует на ее основе словарь с
    помощью генератора. Ключами выступают символы строки, значениями-количества
    вхождений каждого из символа в строку
    :param our_str:
    :return: letters_dict
    """
