...
def to_roman(val):
    """
    Функция принимает на вход арабское число и преобразует его в римское.
    Создаем словарь (ключи- римские цифры, значения-соответствующие им арабские цифры).
    Затем в цикле сравниваем арабское число, принятое на вход, со значениями словаря.
    Найденные ключи добавляем в строку результата, уменьшая исходное число на значение
    добавленного в строку ключа.
